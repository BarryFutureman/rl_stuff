...
class CartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    ...
    **Note:** While the ranges above denote the possible values for observation space of each element,
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.observation_space = spaces.Box(-high, high, shape=(self.memory_length, 4), dtype=np.float32)
    ...
    def step(self, action):
        ...
        # My edit here: update state
        self.state.pop(0)
        self.state.append((x, x_dot, theta, theta_dot))
    ...
    def reset(
        ...
        *,
        ...
        # My edit here
        self.state = [self.np_random.uniform(low=low, high=high, size=(4,)) for _ in range(self.memory_length)]
