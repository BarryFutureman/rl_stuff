...
from trainer.ppo.ppo_with_memory import PPO
from architectures.Jamba.cnn_jamba_policy_shared import PixelBasedActorCriticPolicy
...
def train_model(
    ...
    while model.num_timesteps < total_timesteps:
        ...
        for rollout in rollout_generator:
            rgb_obs_to_display = np.transpose(rollout[0], (0, 2, 3, 1))

            # raise NotImplementedError()
            # TODO: transposing here is a bit slow maybe? perhaps move the transpose to the CNN model
