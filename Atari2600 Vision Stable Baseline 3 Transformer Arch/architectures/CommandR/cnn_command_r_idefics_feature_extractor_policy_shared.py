...
class VLM(BaseFeaturesExtractor):
    def __init__(
            self,
        ...
        self.vlm = Idefics2ModelForRLFeatureExtraction(config=vlm_config)
        print(self.vlm)
        # quit()
    ...
    def forward(self, observations: th.Tensor) -> th.Tensor:
        ...
        features = self.vlm(pixel_values=observations)
