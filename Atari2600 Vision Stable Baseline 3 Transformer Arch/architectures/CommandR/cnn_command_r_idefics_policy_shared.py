...
from .idefics2.modeling_idefics2_for_rl import *
...
class VLMActorCriticNetwork(nn.Module):
    def __init__(
            self,
    ):
        super().__init__()
        ...
        self.policy_net = Idefics2ModelForRLFeatureExtraction(config=vlm_config, out_latent_dim=self.latent_dim_pi)
...
class VisionPreprocessor(BaseFeaturesExtractor):
    def __init__(
            self,
...
class PixelBasedActorCriticPolicy(ActorCriticPolicy):
    def __init__(
        ...
        super().__init__(
            ...
            action_space,
            lr_schedule,
            features_extractor_class=VisionPreprocessor,
    ...
    def _build_mlp_extractor(self) -> None:
        self.mlp_extractor = VLMActorCriticNetwork()
