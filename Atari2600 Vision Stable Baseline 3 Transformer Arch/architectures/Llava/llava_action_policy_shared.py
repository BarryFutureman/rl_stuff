...
from .modeling_llava import Idefics2Config, Idefics2ModelForRLFeatureExtraction, Idefics2VisionConfig
...
class VisionActorCriticNetwork(nn.Module):
    def __init__(
        ...
        self.policy_net = Idefics2ModelForRLFeatureExtraction(config, self.latent_dim_pi)
