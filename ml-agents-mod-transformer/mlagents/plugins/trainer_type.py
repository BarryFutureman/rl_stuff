...
from mlagents.my_mod.trainers.my_transformer_ppo.trainer import PPOTrainer as MyPPOTrainer
from mlagents.my_mod.trainers.my_transformer_ppo.optimizer_torch import PPOSettings as MyPPOSettings
    ...
    mla_plugins.all_trainer_types.update(
        {
            ...
            MyPPOTrainer.get_trainer_name(): MyPPOTrainer,
        }
    )
    ...
    mla_plugins.all_trainer_settings.update(
        {
            ...
            MyPPOTrainer.get_trainer_name(): MyPPOSettings,
        }
    )
