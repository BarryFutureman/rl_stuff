...
class MasterTrainer:
    ...
    def run_cli(self, options: RunOptions) -> None:
        try:
            print(
                """
                ┐  ╖
     ...
     ╙   ╓╦╖    ╬╬╣╣   ╓╗╗╖            ╙╝╣╣╣╣╝╜   ╘╝╝╜   ╝╝╝  ╝╝╝   ╙╣╣╣    ╟╣╣╣
       ╩╬╬╬╬╬╬╦╦╬╬╣╣╗╣╣╣╣╣╣╣╝                                             ╫╣╣╣╣
        ...
        self.run_training(run_seed, options, num_areas)

    def run_training(self, run_seed: int, options: RunOptions, num_areas: int) -> None:
        """
        ...
        with hierarchical_timer("run_training.setup"):
            ...
            # self.env_factory is a callable
            self.env_factory = create_environment_factory(
            ...
            self.env_manager = SubprocessEnvManager(self.env_factory, options, env_settings.num_envs)
        ...
        # Begin training
        try:
            tc.start_learning(self.env_manager)
        finally:
