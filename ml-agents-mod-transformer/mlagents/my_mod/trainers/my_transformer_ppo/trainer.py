...
from mlagents.my_mod.trainers.my_transformer_ppo.optimizer_torch import TorchPPOOptimizer, PPOSettings
from mlagents.trainers.trajectory import Trajectory
from mlagents.trainers.behavior_id_utils import BehaviorIdentifiers
from mlagents.trainers.settings import TrainerSettings

from mlagents.my_mod.custom_models.nature_vision_actor import NatureVisionActor

logger = get_logger(__name__)

TRAINER_NAME = "my_transformer_ppo"
...
class PPOTrainer(OnPolicyTrainer):
    ...
    def __init__(
        ...
        self.policy: MyTorchPolicy = None  # type: ignore
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchPPOOptimizer(  # type: ignore
            cast(MyTorchPolicy, self.policy), self.trainer_settings  # type: ignore
        )  # type: ignore
