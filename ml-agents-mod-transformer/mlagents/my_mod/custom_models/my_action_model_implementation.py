...
from mlagents.my_mod.custom_models.my_distribution_implementation import (
    DistInstance,
...
class MyActionModel(nn.Module):
    ...
    def get_action_out(self, inputs: torch.Tensor, masks: torch.Tensor) -> tuple[
        Tensor | None | Any, Tensor | None, Tensor | None | Any, Tensor | None]:
        """
