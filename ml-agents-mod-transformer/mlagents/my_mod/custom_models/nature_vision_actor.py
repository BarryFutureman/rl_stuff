...
from mlagents.my_mod.custom_models.vision_transformer_network_body import VisionTransformerNetworkBody


# TODO: Figure about the path where action spec and obs spec comes in and what do they look like
class NatureVisionActor(nn.Module, Actor):
    ...
    def __init__(
        ...
        self.network_body = VisionTransformerNetworkBody(observation_specs,
                                                         network_settings)
