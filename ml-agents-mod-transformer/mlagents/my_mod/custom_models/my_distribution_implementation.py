...
class GaussianDistribution(nn.Module):
    ...
    def forward(self, inputs: torch.Tensor) -> Union[DistInstance, TanhGaussianDistInstance, GaussianDistInstance]:
        mu = self.mu(inputs)
...
class MultiCategoricalDistribution(nn.Module):
    def __init__(self, hidden_size: int, act_sizes: tuple[int]):
        super().__init__()
