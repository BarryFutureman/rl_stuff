...
from mlagents.my_mod.custom_models.policy.my_torch_policy import MyTorchPolicy
...
class TorchModelSaver(BaseModelSaver):
    ...
    def __init__(
        ...
        self.policy: Optional[MyTorchPolicy] = None
        self.exporter: Optional[ModelSerializer] = None
        self.modules: Dict[str, torch.nn.Modules] = {}

    def register(self, module: Union[MyTorchPolicy, TorchOptimizer]) -> None:
        if isinstance(module, MyTorchPolicy) or isinstance(module, TorchOptimizer):
        ...
        if self.policy is None and isinstance(module, MyTorchPolicy):
            self.policy = module
    ...
    def initialize_or_load(self, policy: Optional[MyTorchPolicy] = None) -> None:
    ...
    def _load_model(
        self,
        load_path: str,
        policy: Optional[MyTorchPolicy] = None,
        ...
        policy = cast(MyTorchPolicy, policy)
